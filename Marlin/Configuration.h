...
#define MP_SCARA
  ...
  #define DEFAULT_SCARA_SEGMENTS_PER_SECOND 200
  // If movement is choppy try lowering this value


  // Length of inner and outer support arms. Measure arm lengths precisely.
  #define SCARA_LINKAGE_1 450.0    // (mm) pro me L3
  #define SCARA_LINKAGE_2 435.0    // (mm) pro me L4
  #define SCARA_LINKAGE_3 512.0    // (mm) pro me vyska stolu

  // SCARA tower offset (position of Tower relative to bed zero position)
  // This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
  #define SCARA_OFFSET_X    0       // (mm)
  #define SCARA_OFFSET_Y    0       // (mm)
  #define SCARA_OFFSET_TOOL 0       // (mm)
    ...
    #define MIDDLE_DEAD_ZONE_R   150  // (mm)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 133.33333333, 88.88888889, 88.88888889, 97.89 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 60.0, 60.0, 60.0, 25.0 }
...
#define MANUAL_X_HOME_POS 569.2450//598.669
#define MANUAL_Y_HOME_POS 9.3389
#define MANUAL_Z_HOME_POS 803.9497  //712.403
